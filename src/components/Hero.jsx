...
export default function Hero() {
  return (
    <section style={{ position: 'relative', height: 'clamp(240px,42vw,420px)', overflow: 'hidden', background: '#34304a' }}>
      <img src={heroImg} alt="Healing Nations outreach" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 35%', transformOrigin: 'center 35%', animation: 'hngKen 16s ease-out both' }} />
